...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions
        ...
        var backButtonImage = UIImage(systemName: "arrow.backward",
                                      withConfiguration: UIImage.SymbolConfiguration(pointSize: 20.0, weight: .bold))
        backButtonImage = backButtonImage?.withAlignmentRectInsets(UIEdgeInsets(top: 0,
    ...
    lazy var persistentContainer: NSPersistentContainer = {
     ...
     Beginning iOS Programming with Swift and UIKit (iOS 15) | APPCODA
    598
     */
        ...
        container.loadPersistentStores(completionHandler: { (_, error) in
            if let error = error as NSError? {
                ...
                // fatalError() causes the application to generate a crash logand terminate. You should not
    ...
    func saveContext () {
        ...
        if context.hasChanges {
            do {
                ...
                // Replace this implementation with code to handle the error appropriately.
                /* fatalError() causes the application to generate a crash logand terminate.
