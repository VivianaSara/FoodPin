...
class WalkthroughPageViewController: UIPageViewController {
    ...
    private var pageHeadings = [String(localized: "CREATE YOUR OWN FOOD GUIDE"),
    ...
    private var pageSubHeadings = [String(localized: "Pin your favorite restaurants and create your own food guide"),
